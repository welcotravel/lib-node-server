...
export default class WelcomeServer<AppConfig> {
    ...
    constructor(sName: string, oHttpListener: HttpListener, mPortOrConfigPath: string | number) {
    ...
    async initWithConsulConfig(sConfigPrefix: string, aConfigPaths: string[], fAfterConfig: AfterConfig) {
