...
class WelcomeServer {
    constructor(sName, oHttpListener, mPortOrConfigPath) {
        this.sConfigPath = '';
        this.sConfigPrefix = '';
        this.aConfigPaths = [];
        this.iPort = 80;
    ...
    async initWithConsulConfig(sConfigPrefix, aConfigPaths, fAfterConfig) {
    ...
    async initWithJsonConfig(sConfigPath, fAfterConfig) {
